...
export const ValidatorStats = ({validator}: IValidatorStatsProps): ReactElement => {
    ...
    return (
        <div className='validator-details-stats'>
            ...
            <div className='beacon-node-charts-container'>
                <ValidatorAttestationsTable publicKey={validator.publicKey} slot={beaconNode?.slot || 0} />
                <ValidatorPropositionsTable publicKey={validator.publicKey} slot={beaconNode?.slot || 0} />
            </div>
