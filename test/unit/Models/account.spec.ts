...
import {Eth1ICGKeystoreFactory, Eth1ICGKeystore} from "../../../src/renderer/services/Eth1ICGKeystore";
...
describe("CGAccount tests", () => {
    ...
    beforeEach(() => {
        ...
        // ! This doesn't work with regular import, but works with require import
        ...
        sandbox
            ...
            .returns(true);
        // ! This doesn't work when require import is used, but works with regular import
        // sandbox
        //     .stub(fs, "readFileSync")
        //     .withArgs("./test_keystores/keystore1.json", 'utf8')
        //     .returns("Text")
        //     .withArgs("./test_keystores/keystore2.json")
        //     .returns(mockKeystore);

        sandbox.stub(Eth1ICGKeystoreFactory.prototype, "getAddress").returns("0x001");
        sandbox
