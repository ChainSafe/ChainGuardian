    ...
    it("should create keystore", () => {
        ...
        const readStub = sandbox
            ...
            .returns(
                JSON.stringify({
                    "version": 3,
                    "id": "c12d6151-1f90-426d-b9b0-e39f1bcf80bd",
                    "address": [
                        20,
                        4,
                        22,
                    ...
                    "crypto": {
                        "ciphertext": "e04dc10b2821d90e293df239d63e8facce5aad9154dcf7a14305f7e25e69289d",
                        "cipherparams": {
                            "iv": "62bd08907cd3f1b79db6c733ff7045de"
                        },
                        "cipher": "aes-128-ctr",
                        "kdf": "pbkdf2",
                        "kdfparams": {
                            "dklen": 32,
                            "salt": "f94a06f3e07ac0943184a59215c5b63872057af5fc7d58882b0ae186b1e49896",
                            "c": 262144,
                            "prf": "hmac-sha256"
                        },
                        "mac": "4c7f2569c4e07adb55a496aeabe0605096708e9f893ddd47b9bff1444534dff0"
                    }
                })
            );
